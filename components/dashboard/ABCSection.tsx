              ...
              <Card key={cls} className="p-3 flex flex-col gap-2">
                <div className="flex items-center gap-1.5">
                  <span
                    ...
                    style={{ background: CLASS_BG[cls], border: `1px solid ${CLASS_BORDER[cls]}`, color: CLASS_COLOR[cls] }}
                  >
                    {cls}
                  </span>
                ...
                >
                  ...
                  <div className="hidden sm:flex items-center px-2">
                    <div className="flex-1 h-1.5 rounded-full overflow-hidden" style={{ background: 'rgba(255,255,255,0.06)' }}>
                      <div className="h-full rounded-full transition-all" style={{ width: `${item.pct}%`, background: CLASS_COLOR[item.cls] }} />
                    </div>
                  </div>
                  ...
                  <span
                    ...
                    style={{ background: CLASS_BG[item.cls], border: `1px solid ${CLASS_BORDER[item.cls]}`, color: CLASS_COLOR[item.cls] }}
                  >
                    {item.cls}
                  </span>
                </div>
